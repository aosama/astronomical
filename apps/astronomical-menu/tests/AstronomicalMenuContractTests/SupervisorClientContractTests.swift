...
final class SupervisorClientContractTests: XCTestCase {
  ...
  func test_should_decode_reload_generation_and_full_loaded_model_configuration() throws {
    let responseBody = Data(#"{"message":"Config reloaded and applied by the worker","worker_restart_completed":true,"candidate_generation":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","effective_generation":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","worker_runtime_feature_configuration":{"configuration_generation":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","persistent_prompt_cache_enabled":true,"prompt_cache_maximum_size_bytes":50000000000,"loaded_model":{"kind":"autoregressive","configuration":{"model_id":"fictional/target","maximum_context_tokens":32768,"maximum_output_tokens":4096,"chunking":{"fixed_prompt_processing_chunk_size_tokens":2048,"fixed_ssd_streaming_prompt_processing_chunk_size_tokens":256,"full_attention_key_value_growth_tokens":256,"speculative_prefill_draft_forward_tokens":1024,"prefill_graph_submission_layer_interval":0,"experimental_ssd_paging_prefill_graph_submission_layer_interval":1,"experimental_ssd_paging_generation_graph_submission_layer_interval":0,"prompt_cache_block_tokens":128,"prompt_cache_common_prefix_stride_blocks":4,"experimental_decode_stage_attribution_enabled":false,"experimental_quantized_kv_cache_enabled":false,"experimental_fused_moe_decode_enabled":false},"mtp_enabled":true,"mtp_draft_depth":3,"speculative_prefill_enabled":true,"speculative_prefill":{"draft_model_id":"fictional/draft","minimum_prompt_tokens":8192,"keep_percentage":20}}}}}"#.utf8)
    ...
    XCTAssertEqual(
      loadedModelConfiguration?.speculativePrefill?.draftModelIdentifier,
      "fictional/draft")
  }
