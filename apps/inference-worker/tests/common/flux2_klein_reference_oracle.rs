//! Independent FLUX RGB oracle contract shared by hermetic and real-model qualification.
//!
...
#[cfg(feature = "model-artifact-qualification")]
pub(crate) const REFERENCE_BUNDLE_ENVIRONMENT_VARIABLE: &str =
    "ASTRONOMICAL_FLUX2_KLEIN_REFERENCE_BUNDLE";
...
const BFL_SOURCE_REVISION: &str = "50fe5162777813d869182b139e83b10743caef15";
const DIFFUSERS_SOURCE_REPOSITORY: &str = "https://github.com/huggingface/diffusers";
const DIFFUSERS_SOURCE_REVISION: &str = "2f7e0154a9db246e95c9ede43edba7db5b130805";
...
pub(crate) struct FluxReferenceOracle {
    ...
    #[cfg(feature = "model-artifact-qualification")]
    bfl_source_revision: String,
    #[cfg(feature = "model-artifact-qualification")]
    diffusers_source_revision: String,
}
...
impl FluxReferenceOracle {
    #[cfg(feature = "model-artifact-qualification")]
    pub(crate) fn read_from_environment(
        ...
        Self::parse(&bundle_bytes, expected)
    }
    ...
    pub(crate) fn parse(
        ...
        let _bfl_source_revision = require_pinned_source_revision(
            bundle_object,
            "bfl_source_revision",
            BFL_SOURCE_REVISION,
        )?;
        let _diffusers_source_revision = require_pinned_source_revision(
            bundle_object,
            "diffusers_source_revision",
            DIFFUSERS_SOURCE_REVISION,
        )?;
        ...
        Ok(Self {
            ...
            #[cfg(feature = "model-artifact-qualification")]
            bfl_source_revision: _bfl_source_revision,
            #[cfg(feature = "model-artifact-qualification")]
            diffusers_source_revision: _diffusers_source_revision,
        })
    }
    ...
    #[cfg(feature = "model-artifact-qualification")]
    pub(crate) fn bfl_source_revision(&self) -> &str {
        &self.bfl_source_revision
    }

    #[cfg(feature = "model-artifact-qualification")]
    pub(crate) fn diffusers_source_revision(&self) -> &str {
        &self.diffusers_source_revision
    }
}
...
fn require_equal_string(
    ...
    if actual != expected {
        return Err(format!(
            "reference bundle {field_name} does not match the qualification input"
        ));
    }
    Ok(())
}
