...
//!
//! **These tests are intentionally slow**: they launch the complete supervisor + worker stack,
//! load Ornith, and exercise persistent prompt cache save and restore with
