...
pub(super) fn handle_worker_completion_event(
    ...
    performance_log.record(&GenerationPerformanceRecord {
        ...
        final_resident_expert_count: completed_request.final_resident_expert_count,
        final_resident_expert_payload_bytes: completed_request.final_resident_expert_payload_bytes,
