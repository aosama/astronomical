...
pub use memory::{
    ...
    MtpMemoryProjectionError, RamBudgetGeometryError, RequestExpertLayerRole,
    RequestExpertResidency, ResidentExpertWeight, RetainedExpertPageClass, RotatingAdmissionError,
    SpeculativePrefillAdmission, classify_expert_memory_mode, combined_persistent_growth_bytes,
    ...
    measured_non_expert_forward_growth_bytes, persistent_context_restore_workspace_bytes,
    plan_expert_residency, projected_active_memory_after_complete_expert_replacement,
