...
pub use qwen3_5::{
    ...
    Qwen3_5MtpRequestEligibility, Qwen3_5MtpRequestEligibilityInputs, Qwen3_5MtpSidecarDeclaration,
    Qwen3_5MtpSidecarDeclarationError, Qwen3_5MtpSidecarValidationOutcome,
    Qwen3_5MtpSourceSelection, Qwen3_5MtpSourceUnavailableReason, Qwen3_5MtpTargetOnlyReason,
    Qwen3_5OutputEvent, Qwen3_5OutputParser, Qwen3_5OutputParserError, Qwen3_5ProcessedImage,
    Qwen3_5PromptError, Qwen3_5PromptRenderer, Qwen3_5RenderedPrompt, Qwen3_5RequestOutput,
    ...
    Qwen3_5StandaloneMtpConfig, Qwen3_5StandaloneMtpConfigError, Qwen3_5TokenDecoder,
    ...
    StandaloneMtpNamespaceError, ValidatedQwen3_5Artifact, ValidatedQwen3_5StandaloneMtpArtifact,
    compare_qwen3_5_mtp_pairing_contracts, discover_sampler_config, discover_token_ids,
    normalize_qwen3_5_standalone_mtp_tensor_name, plan_qwen3_5_visual_embedding_suffix,
    predictor_history_requires_verified_hidden_replay, qwen3_5_decoder_cache_layout,
    ...
    qwen3_5_mtp_request_eligibility, qwen3_5_mtp_tensor_names, qwen3_5_mtp_tensor_profiles,
