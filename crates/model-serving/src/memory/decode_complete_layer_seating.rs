...
use super::expert_residency::{ExpertLayerResidencyTarget, PhaseAwareExpertResidencyPlan};
...
#[must_use]
pub fn complete_layer_indexes_required_before_decode(
    plan: &PhaseAwareExpertResidencyPlan,
) -> Vec<usize> {
