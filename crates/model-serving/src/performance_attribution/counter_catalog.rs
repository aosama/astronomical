...
pub enum PerformanceCounter {
    ...
    MtpProposedDraftPositionOneCount,
    MtpProposedDraftPositionTwoCount,
    MtpProposedDraftPositionThreeCount,
    MtpAcceptedDraftPositionOneCount,
    MtpAcceptedDraftPositionTwoCount,
    MtpAcceptedDraftPositionThreeCount,
    MtpRejectedDraftPositionOneCount,
    MtpRejectedDraftPositionTwoCount,
    MtpRejectedDraftPositionThreeCount,
    ...
    MtpRequestTargetOnlyFallbackCount,
...
impl PerformanceCounter {
    ...
    pub(super) const ALL: [Self; Self::COUNT] = [
        ...
        Self::MtpProposedDraftPositionOneCount,
        Self::MtpProposedDraftPositionTwoCount,
        Self::MtpProposedDraftPositionThreeCount,
        Self::MtpAcceptedDraftPositionOneCount,
        Self::MtpAcceptedDraftPositionTwoCount,
        Self::MtpAcceptedDraftPositionThreeCount,
        Self::MtpRejectedDraftPositionOneCount,
        Self::MtpRejectedDraftPositionTwoCount,
        Self::MtpRejectedDraftPositionThreeCount,
        ...
        Self::MtpRequestTargetOnlyFallbackCount,
    ...
    pub(super) const fn identifier(self) -> &'static str {
        match self {
            ...
            Self::MtpProposedDraftPositionOneCount => "mtp_proposed_draft_position_one_count",
            Self::MtpProposedDraftPositionTwoCount => "mtp_proposed_draft_position_two_count",
            Self::MtpProposedDraftPositionThreeCount => "mtp_proposed_draft_position_three_count",
            Self::MtpAcceptedDraftPositionOneCount => "mtp_accepted_draft_position_one_count",
            Self::MtpAcceptedDraftPositionTwoCount => "mtp_accepted_draft_position_two_count",
            Self::MtpAcceptedDraftPositionThreeCount => "mtp_accepted_draft_position_three_count",
            Self::MtpRejectedDraftPositionOneCount => "mtp_rejected_draft_position_one_count",
            Self::MtpRejectedDraftPositionTwoCount => "mtp_rejected_draft_position_two_count",
            Self::MtpRejectedDraftPositionThreeCount => "mtp_rejected_draft_position_three_count",
            ...
            Self::MtpRequestTargetOnlyFallbackCount => "mtp_request_target_only_fallback_count",
