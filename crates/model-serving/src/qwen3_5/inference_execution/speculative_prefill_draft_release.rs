...
use crate::{InferenceEngineError, PerformanceOperation, Qwen3_5Model};

use super::{
    Qwen3_5EngineState, engine_request::Qwen3_5EngineRequest,
...
impl Qwen3_5EngineState {
    ...
    pub(super) fn release_speculative_prefill_draft_and_restore_target_residency(
        &mut self,
