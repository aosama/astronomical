...
pub use artifacts::{
    ...
    Qwen3_5MtpTargetOnlyReason, Qwen3_5RamBudgetGeometryError, Qwen3_5ShardIndex,
    ValidatedQwen3_5Artifact, mlx_ram_budget_model_geometry_from_validated_artifact,
...
pub use multi_token_prediction::{
    ...
    qwen3_5_mtp_request_is_eligible, qwen3_5_mtp_verification_decision,
