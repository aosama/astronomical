...
use astronomical_ipc_protocol::MtpDepthStatus;

use super::{
    MtpDraftDepth, Qwen3_5MtpArtifactCapability, Qwen3_5MtpTargetOnlyReason,
    Qwen3_5MtpUnavailableReason,
};
    ...
    match mtp_artifact_capability {
        ...
        Qwen3_5MtpArtifactCapability::MtpCapable { .. } => {
            let artifact_maximum_draft_depth =
                artifact_maximum_draft_depth.unwrap_or(MtpDraftDepth::DEPTH_ONE);
            ...
            if resolved_draft_depth > artifact_maximum_draft_depth {
                let reason = Qwen3_5MtpTargetOnlyReason::ConfiguredDepthExceedsArtifact {
                    configured_depth: resolved_draft_depth,
                    artifact_maximum_depth: artifact_maximum_draft_depth,
                };
                return (
            ...
            depth_status.effective_execution_draft_depth = Some(resolved_draft_depth.get());
