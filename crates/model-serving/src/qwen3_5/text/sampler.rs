...
/// Builds one lazy Qwen3.5 sample using a fully GPU-resident top-k + top-p pipeline.
///
...
pub(in crate::qwen3_5) fn build_qwen3_5_sampled_token(
    ...
    let masked_selected_logits = qwen3_5_apply_top_p_mask(
        runtime,
...
pub fn qwen3_5_apply_top_p_mask(
    runtime: &MlxRuntime,
