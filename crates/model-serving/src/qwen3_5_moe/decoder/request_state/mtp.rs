...
pub struct Qwen3_5MoEMtpRequestState {
...
pub struct Qwen3_5MoEMtpRequestStateAllocationCheckpoint {
    full_attention_key_value_state: FullAttentionKeyValueStateAllocationCheckpoint,
}

impl Qwen3_5MoEMtpRequestState {
    ...
    pub fn allocation_checkpoint(
        &self,
    ) -> Result<Qwen3_5MoEMtpRequestStateAllocationCheckpoint, MlxRuntimeError> {
        Ok(Qwen3_5MoEMtpRequestStateAllocationCheckpoint {
    ...
    pub fn restore_allocation_checkpoint(
        &mut self,
        allocation_checkpoint: Qwen3_5MoEMtpRequestStateAllocationCheckpoint,
    ) -> Result<(), MlxRuntimeError> {
        self.full_attention_key_value_state
            .restore_allocation_checkpoint(allocation_checkpoint.full_attention_key_value_state)
    }

    pub(in crate::qwen3_5_moe) fn full_attention_key_value_state_mut(
        &mut self,
    ...
    pub(in crate::qwen3_5_moe) fn full_attention_key_value_state(
        &self,
    ) -> &FullAttentionKeyValueState {
        &self.full_attention_key_value_state
    }
}

impl Default for Qwen3_5MoEMtpRequestState {
    fn default() -> Self {
...
pub enum Qwen3_5MoEMtpUnavailableReason {
    /// The model has no compatible MTP head.
    NoCompatibleHead,
}

impl std::fmt::Display for Qwen3_5MoEMtpUnavailableReason {
