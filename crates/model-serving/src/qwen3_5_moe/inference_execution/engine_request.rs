...
use crate::{
    ...
    PersistentPromptCacheBlockKey, Qwen3_5MoESamplingStrategy,
};

use super::super::text::sampler::build_qwen3_5_moe_sampled_token;
use super::super::{
    ExpertWeightMemoryCacheStatistics, Qwen3_5MoEModel, Qwen3_5MoEMtpRequestState,
    Qwen3_5MoEMtpRequestStateAllocationCheckpoint, RequestDecoderStateStack,
    RequestDecoderStateStackAllocationCheckpoint,
};
use super::{fatal_engine_error, qwen3_5_moe_runtime_error};
...
pub(super) struct Qwen3_5MoEPrefillRequestCheckpoint {
    request_decoder_state_allocation_checkpoint: RequestDecoderStateStackAllocationCheckpoint,
    mtp_request_state_allocation_checkpoint: Option<Qwen3_5MoEMtpRequestStateAllocationCheckpoint>,
    prefill_cursor: usize,
    next_position_tokens: u32,
    consumed_visual_embedding_count: usize,
}

pub(in crate::qwen3_5_moe) struct Qwen3_5MoEEngineRequest {
    ...
    pub(super) sampling_strategy: Qwen3_5MoESamplingStrategy,
    ...
    pub(super) mtp_request_state: Option<Qwen3_5MoEMtpRequestState>,
...
impl Qwen3_5MoEEngineRequest {
    /// Retains mutable prompt state before an attempt that can hit MLX's hard ceiling.
    pub(super) fn prefill_request_checkpoint(
        &self,
    ) -> Result<Qwen3_5MoEPrefillRequestCheckpoint, MlxRuntimeError> {
        Ok(Qwen3_5MoEPrefillRequestCheckpoint {
            ...
            mtp_request_state_allocation_checkpoint: self
                .mtp_request_state
                .as_ref()
                .map(Qwen3_5MoEMtpRequestState::allocation_checkpoint)
                .transpose()?,
    ...
    pub(super) fn restore_prefill_request_checkpoint(
        &mut self,
        prefill_request_checkpoint: Qwen3_5MoEPrefillRequestCheckpoint,
                ...
                .is_some()
        {
            return Err(MlxRuntimeError::RuntimeOperation {
                operation: "restore Qwen3.5-MoE prefill request checkpoint",
                description:
    ...
    pub(super) fn build_generated_token(
        ...
        let generated_token_outcome = self.performance_attribution.measure_operation(
            ...
            |_performance_attribution| match sampling_strategy {
                Qwen3_5MoESamplingStrategy::Greedy => model
                ...
                Qwen3_5MoESamplingStrategy::TopKTopP {
                    ...
                    top_p_thousandths,
                    ..
                } => build_qwen3_5_moe_sampled_token(
                    model,
                    logits,
                    temperature_thousandths,
                    top_p_thousandths,
