...
use crate::{
    ...
    PersistentVisualEmbeddingModelContract, Qwen3_5MoEInferenceRequest,
    build_persistent_prompt_cache_stats_event,
};

use self::engine_request::Qwen3_5MoEEngineRequest;
use super::ValidatedQwen3_5MoEArtifact;
use super::model::Qwen3_5MoEModel;

pub use generated_token_emission::{
    qwen3_5_moe_depth_one_mtp_window_fits, qwen3_5_moe_mtp_verification_may_cross_thinking_budget,
};
pub use memory_limit::safe_minimum_mlx_memory_ceiling_bytes;
pub use model_loading::qwen3_5_moe_mtp_runtime_state_after_load;
pub use prefill_chunck_sizer::{Qwen3_5MoEPrefillChunckSizer, Qwen3_5MoEPrefillChunckSizerError};

/// Qwen3.5 inference engine backed by the architecture-neutral MLX owner driver.
pub type Qwen3_5MoEEngine = MlxInferenceEngine<Qwen3_5MoEInferenceExecution>;
...
impl MlxInferenceEngine<Qwen3_5MoEInferenceExecution> {
    ...
    pub fn new_with_prefill_chunck_sizer(
        ...
        mtp_enabled: bool,
    ) -> Result<Qwen3_5MoEEngine, InferenceEngineError> {
    ...
    pub fn new_with_prefill_chunck_sizer_and_performance_attribution(
        ...
        let context_memory_reservation_bytes_per_token = validated_artifact
            ...
            .ok_or_else(|| {
                fatal_engine_error("Qwen3.5-MoE context memory reservation overflowed")
            })?;
        ...
        MlxInferenceEngine::new(move || Qwen3_5MoEInferenceExecution {
            active_request: None,
            ...
            mtp_runtime_state: if mtp_enabled {
                Qwen3_5MoEMtpRuntimeState::Unavailable
            } else {
                Qwen3_5MoEMtpRuntimeState::Disabled
            },
...
pub struct Qwen3_5MoEInferenceExecution {
    pub(super) active_request: Option<Qwen3_5MoEEngineRequest>,
    ...
    pub(super) model: Option<Qwen3_5MoEModel>,
    ...
    prefill_chunck_sizer: Qwen3_5MoEPrefillChunckSizer,
    validated_artifact: Option<ValidatedQwen3_5MoEArtifact>,
    vocabulary_size: u32,
    ...
    mtp_runtime_state: Qwen3_5MoEMtpRuntimeState,
    /// Concise reason when MTP runtime state is Unavailable.
    mtp_unavailable_reason: Option<String>,
}

pub(super) type Qwen3_5MoEEngineState = Qwen3_5MoEInferenceExecution;

impl MlxInferenceExecution for Qwen3_5MoEInferenceExecution {
    type Request = Qwen3_5MoEInferenceRequest;

    fn load(&mut self) -> Result<EngineLoadResult, InferenceEngineError> {
        Qwen3_5MoEEngineState::load(self)
    }
    ...
    fn start_generation(
        ...
        Qwen3_5MoEEngineState::start_generation(self, inference_request)
    }
    ...
    fn decode_next_token(
        ...
        Qwen3_5MoEEngineState::advance_generation(self, request_id)
    }
    ...
    fn inject_input_tokens(
        ...
        Qwen3_5MoEEngineState::inject_input_tokens(self, request_id, input_token_ids)
    }
    ...
    fn cancel_generation(
        ...
        Qwen3_5MoEEngineState::cancel_generation(self, request_id)
    }

    fn collect_persistent_prompt_cache_stats(
        &self,
    ) -> Result<Option<WorkerEvent>, InferenceEngineError> {
        Ok(Qwen3_5MoEEngineState::collect_persistent_prompt_cache_stats(self))
    }

    fn collect_mlx_memory_telemetry(
        &self,
    ) -> Result<Option<MlxMemoryTelemetry>, InferenceEngineError> {
        Qwen3_5MoEEngineState::collect_current_mlx_memory_telemetry(self)
    }
    ...
    fn update_mlx_memory_limit(
        ...
        Qwen3_5MoEEngineState::update_mlx_memory_limit(self, requested_mlx_memory_ceiling_bytes)
    }
}
...
pub enum Qwen3_5MoEMtpRuntimeState {
    Disabled,
    TargetOnly,
    Active,
    Unavailable,
...
pub(super) fn qwen3_5_moe_runtime_error(
    runtime_error: impl std::fmt::Display,
