...
/// Owns Qwen3.5-MoE prompt-processing `prefill_chunck_tokens` selection and boundary calculation.
#[derive(Clone, Debug, Eq, PartialEq)]
pub struct Qwen3_5MoEPrefillChunckSizer {
...
impl Qwen3_5MoEPrefillChunckSizer {
    ...
    pub fn for_optimized_production_with_persisted_state(
        ...
        let prefill_chunck_size_optimizer = match PrefillChunckSizeOptimizer::load_from_path(
            ...
            Ok(None) => {
                ...
                .map_err(|_| Qwen3_5MoEPrefillChunckSizerError::OptimizerRejectedCandidateSet)?
            }
        ...
        let active_prefill_chunck_tokens = prefill_chunck_size_optimizer
            ...
            .first()
            .copied()
            .ok_or(Qwen3_5MoEPrefillChunckSizerError::OptimizerRejectedCandidateSet)?;
        Ok(Self {
    ...
    pub fn for_fixed_prefill_chunck_tokens(
        ...
        let fixed_prefill_chunck_tokens = usize::try_from(fixed_prefill_chunck_tokens)
            .map_err(|_| Qwen3_5MoEPrefillChunckSizerError::ExceedsPlatformRange)?;
        if fixed_prefill_chunck_tokens == 0 {
            return Err(Qwen3_5MoEPrefillChunckSizerError::MustBePositive);
        }
        Ok(Self {
    ...
    pub fn record_prefill_chunck_elapsed_millis(
        ...
        if let Err(prefill_chunck_optimizer_error) = prefill_chunck_size_optimizer.tell(
            ...
            tracing::warn!(
                ...
                "Qwen3.5-MoE prefill_chunck size optimizer rejected an observation"
            );
        }
    ...
    pub fn next_prefill_chunck_end(
        ...
        if candidate_prefill_chunck_tokens != previous_prefill_chunck_tokens {
            tracing::info!(
                ...
                "Qwen3.5-MoE prefill chunk size changed"
            );
        }
        prefill_chunck_start
...
fn maximum_prefill_chunck_tokens_from_u32(
    maximum_prefill_chunck_tokens: u32,
) -> Result<usize, Qwen3_5MoEPrefillChunckSizerError> {
...
/// Invalid explicit Qwen3.5-MoE prompt-processing `prefill_chunck_tokens`.
#[derive(Clone, Debug, Error)]
pub enum Qwen3_5MoEPrefillChunckSizerError {
