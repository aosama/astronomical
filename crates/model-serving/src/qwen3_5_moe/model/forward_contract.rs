...
use super::{Qwen3_5MoEExecutionError, RequestDecoderStateStack};
...
) -> Result<Vec<&'state MlxArray>, Qwen3_5MoEExecutionError> {
...
) -> Result<Vec<&MlxArray>, Qwen3_5MoEExecutionError> {
...
pub(super) fn validate_generated_token_forward(
    ...
    if layer_model_state_count != expected_decoder_layer_count {
        return Err(Qwen3_5MoEExecutionError::DecoderLayerCountMismatch {
...
pub(super) fn validate_forward_input(
    ...
    let token_count =
        u32::try_from(token_ids.len()).map_err(|_| Qwen3_5MoEExecutionError::InvalidInput {
    ...
    i32::try_from(token_count).map_err(|_| Qwen3_5MoEExecutionError::InvalidInput {
