...
use super::{
    Qwen3_5MoEExecutionError, Qwen3_5MoEPagedPrefillExecutionMode, RequestDecoderStateStack,
};
...
impl Qwen3_5MoETargetForwardOutput {
    ...
    pub(in crate::qwen3_5_moe) fn into_pre_final_normalization_hidden_states(self) -> MlxArray {
        self.pre_final_normalization_hidden_states
    }
    ...
    pub(super) fn build_target_forward_graph_from_embeddings(
        ...
        for layer_index in 0..decoder_layer_count {
            let decoder_layer_weights = self
                ...
                .get(layer_index)
                .ok_or(Qwen3_5MoEExecutionError::MissingDecoderLayerWeights { layer_index })?;
        ...
        let (final_logits, all_position_logits) = performance_attribution.measure_operation(
            ...
            |_performance_attribution| {
                ...
                if should_retain_all_position_logits {
                    ...
                    return Ok::<(MlxArray, Option<MlxArray>), Qwen3_5MoEExecutionError>((
                        final_logits,
                ...
                Ok::<(MlxArray, Option<MlxArray>), Qwen3_5MoEExecutionError>((
                    self.runtime.astype(&final_logits, MlxDtype::Float32)?,
                    None,
                ))
            },
        )?;
        Ok(Qwen3_5MoETargetForwardOutput {
            final_logits,
            all_position_logits,
...
pub(super) fn pre_final_normalization_hidden_state_at(
        ...
        || token_position_index >= hidden_state_shape[1]
    {
        return Err(MlxRuntimeError::RuntimeOperation {
            operation: "slice Qwen3.5-MoE pre-final hidden state",
