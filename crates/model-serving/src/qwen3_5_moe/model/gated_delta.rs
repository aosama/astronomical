...
use super::decoder_layer_weights::Qwen3_5MoELinearAttentionWeights;
use super::gated_delta_sequence::qwen3_5_moe_gated_delta_sequence;
...
const GATED_DELTA_STEP_OPERATION: &str = "apply one Qwen3.5-MoE gated-delta recurrent step";

/// Applies one ops-based Qwen3.5-MoE gated-delta recurrence while retaining state in float32.
pub fn qwen3_5_moe_gated_delta_step(
    runtime: &MlxRuntime,
    queries: &MlxArray,
    keys: &MlxArray,
    values: &MlxArray,
...
impl Qwen3_5MoEModel {
    ...
    pub(super) fn forward_linear_attention(
        ...
        token_count: i32,
        linear_attention_weights: &Qwen3_5MoELinearAttentionWeights,
        ...
        let (recurrent_output, next_recurrent_state) = qwen3_5_moe_gated_delta_sequence(
            &self.runtime,
