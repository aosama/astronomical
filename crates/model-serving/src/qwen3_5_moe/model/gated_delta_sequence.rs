...
const GATED_DELTA_SEQUENCE_OPERATION: &str = "apply fused Qwen3.5-MoE gated-delta sequence";
...
/// Builds the fused Qwen3.5-MoE gated-delta sequence kernel.
pub fn qwen3_5_moe_gated_delta_kernel() -> Result<MlxMetalKernel, MlxRuntimeError> {
    MlxMetalKernel::new(
        "astronomical_qwen3_5_moe_gated_delta_sequence",
        &[
            "queries",
            "keys",
            "values",
...
/// Applies fused Qwen3.5-MoE gated-delta recurrence across one prompt/decode sequence.
#[allow(clippy::too_many_arguments)]
pub fn qwen3_5_moe_gated_delta_sequence(
    runtime: &MlxRuntime,
