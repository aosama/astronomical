...
impl Qwen3_5MoEModel {
    pub(in crate::qwen3_5_moe) fn minimum_mlx_memory_ceiling_bytes(
        &self,
    ) -> Result<u64, InferenceEngineError> {
        let current_mlx_memory_snapshot = self
            .runtime
            .memory_snapshot()
            .map_err(super::super::inference_execution::qwen3_5_moe_runtime_error)?;
    ...
    pub(in crate::qwen3_5_moe) fn update_mlx_memory_limit(
        &mut self,
            ...
            .update_memory_limits(requested_mlx_memory_limits)
        {
            ...
            return Err(
                super::super::inference_execution::qwen3_5_moe_runtime_error(runtime_update_error),
            );
        }
        if !is_lowering_mlx_memory_ceiling {
    ...
    fn prepare_expert_residency_for_lower_mlx_memory_limit(
        ...
        let maximum_resident_payload_byte_count = self
