...
use super::adaptive_ram_growth_logging::log_adaptive_ram_growth_pressure;
use super::expert_retention_memory_pressure::reclaim_retained_experts_for_request_memory_pressure;
use super::{Qwen3_5MoEModel, RequestDecoderStateStack};

pub(in crate::qwen3_5_moe) enum AdaptiveRamGrowthMemoryAdmissionError {
...
pub(in crate::qwen3_5_moe) fn validate_context_memory_admission(
...
pub(in crate::qwen3_5_moe) fn invalid_request_error(
...
impl super::super::inference_execution::Qwen3_5MoEEngineState {
    /// Attributes adaptive admission, including any retained-expert reclamation.
    pub(in crate::qwen3_5_moe) fn measure_adaptive_ram_growth_memory_admission(
        &self,
    ...
    fn begin_adaptive_ram_growth(
        ...
        let model = self.model.as_ref().ok_or_else(|| {
            super::super::inference_execution::fatal_engine_error(
                "Qwen3.5-MoE engine lost its loaded model",
            )
        })?;
        ...
        let initial_adaptive_ram_growth_projection = self
            ...
            .map_err(|adaptive_ram_growth_projection_error| {
                tracing::warn!(
                    ...
                    "stopped Qwen3.5-MoE forward after adaptive RAM growth projection failed"
                );
            ...
            let post_reclamation_adaptive_ram_growth_projection = self
                ...
                .map_err(|adaptive_ram_growth_projection_error| {
                    tracing::warn!(
                        action = "reject",
                        error = %adaptive_ram_growth_projection_error,
                        "stopped Qwen3.5-MoE forward after post-reclamation adaptive RAM growth projection failed"
                    );
                    invalid_request_error(format!(
                        "adaptive RAM growth rejected: {adaptive_ram_growth_projection_error}"
                    ))
    ...
    pub(in crate::qwen3_5_moe) fn release_request_memory(
        &self,
...
pub(in crate::qwen3_5_moe) fn collect_completed_forward_memory_snapshot(
    ...
    // The guard stores only the largest temporary window. It does not retain the
    // whole snapshot or allocate memory itself.
...
pub(in crate::qwen3_5_moe) fn record_completed_adaptive_ram_growth(
    adaptive_ram_growth_guard: &mut AdaptiveRamGrowthGuard,
    adaptive_ram_growth_context: AdaptiveRamGrowthContext,
    should_retain_adaptive_ram_growth_observation: bool,
    model: &Qwen3_5MoEModel,
