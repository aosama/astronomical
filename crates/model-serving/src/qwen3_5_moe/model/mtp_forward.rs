...
use super::decoder_layer_weights::{
    Qwen3_5DecoderLayerMlpWeights, Qwen3_5MoEAttentionWeights, Qwen3_5MoEFullAttentionWeights,
};
use super::model::Qwen3_5MoEModel;
use super::{Qwen3_5MoEExecutionError, Qwen3_5MoEPagedPrefillExecutionMode};

/// Evaluated Qwen MTP-head outputs for one or more draft positions.
pub struct Qwen3_5MoEMtpForwardOutput {
    draft_logits: MlxArray,
    post_normalization_hidden_states: MlxArray,
}

impl Qwen3_5MoEMtpForwardOutput {
...
impl Qwen3_5MoEModel {
    ...
    pub fn prefill_mtp_history(
        ...
        mtp_request_state: &mut Qwen3_5MoEMtpRequestState,
    ...
    pub(in crate::qwen3_5_moe) fn prefill_mtp_history_with_performance_attribution(
        &self,
        target_pre_final_normalization_hidden_states: &MlxArray,
        shifted_prompt_token_indices: &MlxArray,
        mtp_request_state: &mut Qwen3_5MoEMtpRequestState,
    ...
    pub(in crate::qwen3_5_moe) fn prefill_mtp_history_from_token_ids_with_performance_attribution(
        &self,
        target_pre_final_normalization_hidden_states: &MlxArray,
    ...
    pub fn forward_mtp_draft(
        ...
        mtp_request_state: &mut Qwen3_5MoEMtpRequestState,
    ) -> Result<Qwen3_5MoEMtpForwardOutput, Qwen3_5MoEExecutionError> {
        let mut disabled_performance_attribution = PerformanceAttribution::disabled();
    ...
    pub(in crate::qwen3_5_moe) fn forward_mtp_draft_with_performance_attribution(
        &self,
        hidden_states_for_mtp_fusion: &MlxArray,
        next_token_indices: &MlxArray,
        mtp_request_state: &mut Qwen3_5MoEMtpRequestState,
        performance_attribution: &mut PerformanceAttribution,
    ) -> Result<(Qwen3_5MoEMtpForwardOutput, u32), Qwen3_5MoEExecutionError> {
    ...
    fn evaluate_mtp_updated_state(
        &self,
        mtp_request_state: &Qwen3_5MoEMtpRequestState,
    ...
    fn build_mtp_hidden_graph(
        ...
        let full_attention_weights = match &mtp_weights.decoder_layer_weights.attention_weights {
            Qwen3_5MoEAttentionWeights::Full(full_attention_weights) => full_attention_weights,
            Qwen3_5MoEAttentionWeights::Linear(_) => {
...
fn validate_mtp_forward_inputs(
    ...
    next_token_indices: &MlxArray,
    hidden_size: i32,
) -> Result<i32, Qwen3_5MoEExecutionError> {
