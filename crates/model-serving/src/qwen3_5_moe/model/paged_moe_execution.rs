...
use super::expert_paging::expert_pager::PagedExpertWeights;
use super::expert_paging::quantized_expert_manifest::QuantizedExpertPageManifest;
...
use super::moe_combination::combine_sparse_and_shared_experts;
...
impl Qwen3_5MoEModel {
    ...
    pub(super) fn copy_sorted_unique_expert_ids(
        ...
        selected_indices: &MlxArray,
        performance_attribution: &mut PerformanceAttribution,
    ) -> Result<Vec<usize>, Qwen3_5MoEExecutionError> {
