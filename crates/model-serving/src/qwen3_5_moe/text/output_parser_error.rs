...
#[derive(Debug, Error)]
pub enum Qwen3_5MoEOutputParserError {
    ...
    #[error(
        "pending Qwen3.5-MoE output is {actual_pending_bytes} bytes, exceeding {maximum_pending_bytes}"
    )]
    ...
    #[error("Qwen3.5-MoE output exceeded the {maximum_tool_call_count}-tool-call limit")]
    TooManyToolCalls {
        /// Fixed accepted maximum.
