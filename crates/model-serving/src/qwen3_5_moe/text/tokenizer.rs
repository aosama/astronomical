...
use crate::{PerformanceAttribution, PerformanceOperation, Qwen3_5MoEInferenceRequest};

use super::{
    Qwen3_5MoEImageProcessor, Qwen3_5MoEProcessedImage, Qwen3_5MoEPromptRenderer,
    ValidatedQwen3_5MoEArtifact,
};

use super::token_ids::{Qwen3_5MoETokenIds, discover_token_ids};
use super::tokenizer_error::Qwen3_5MoETokenizerError;

/// The validated pinned tokenizer used by Qwen3.5-MoE prompt and output processing.
#[derive(Clone, Debug)]
pub struct Qwen3_5MoETokenizer {
    tokenizer: Arc<Tokenizer>,
    tokenizer_vocabulary_size: u32,
    model_vocabulary_size: u32,
    maximum_position_count: u32,
    token_ids: Qwen3_5MoETokenIds,
    model_id: String,
    image_processor: Option<Qwen3_5MoEImageProcessor>,
}

impl Qwen3_5MoETokenizer {
    /// Loads and certifies tokenizer JSON bytes retained by artifact validation.
    pub fn from_json_bytes(
        tokenizer_bytes: &[u8],
        model_vocabulary_size: u32,
        maximum_position_count: u32,
        image_processor: Qwen3_5MoEImageProcessor,
    ...
    fn from_json_bytes_with_optional_image_processor(
        ...
        let tokenizer = Tokenizer::from_bytes(tokenizer_bytes)
            .map_err(|source| Qwen3_5MoETokenizerError::LoadTokenizer { source })?;
        let token_ids = discover_token_ids(&tokenizer)
            .map_err(|source| Qwen3_5MoETokenizerError::DiscoverTokenIds { source })?;
        let tokenizer_vocabulary_size =
            u32::try_from(tokenizer.get_vocab_size(true)).map_err(|_| {
                Qwen3_5MoETokenizerError::TokenizerVocabularyTooLarge {
    ...
    pub fn from_validated_artifact(
        ...
        let tokenizer_bytes = validated_artifact
            .tokenizer_bytes()
            .ok_or(Qwen3_5MoETokenizerError::MissingValidatedTokenizer)?;
        let image_processor = validated_artifact
            .vision_config()
            .map(Qwen3_5MoEImageProcessor::from_vision_config);
    ...
    pub fn encode_prompt(
        &self,
        rendered_prompt: &str,
    ) -> Result<Vec<u32>, Qwen3_5MoETokenizerError> {
        let encoding = self
            .tokenizer
            .encode(rendered_prompt, false)
            .map_err(|source| Qwen3_5MoETokenizerError::EncodePrompt { source })?;
    ...
    pub fn encode_model_visible_correction(
        ...
        let rendered_correction = Qwen3_5MoEPromptRenderer::render_model_visible_correction(
            correction_text,
            enable_thinking,
        );
    ...
    #[must_use]
    pub fn incremental_decoder(&self) -> Qwen3_5MoETokenDecoder {
        Qwen3_5MoETokenDecoder {
    ...
    pub fn prepare_chat(
        ...
        enable_thinking: bool,
    ) -> Result<Qwen3_5MoEInferenceRequest, Qwen3_5MoETokenizerError> {
    ...
    pub(crate) fn prepare_chat_with_performance_attribution(
        ...
        performance_attribution
            ...
            .map_err(Qwen3_5MoETokenizerError::InvalidChatCommand)?;
        ...
        if resolved_requested_model_id != self.model_id {
            return Err(Qwen3_5MoETokenizerError::ModelIdMismatch {
        ...
        let rendered_prompt = performance_attribution
            .measure_operation(
                ...
                |_performance_attribution| {
                    Qwen3_5MoEPromptRenderer::render(
                        &chat_generation_command.messages,
            ...
            .map_err(Qwen3_5MoETokenizerError::RenderPrompt)?;
        ...
        let mut inference_request = Qwen3_5MoEInferenceRequest::new_sampling(
...
pub fn validate_context_token_count(
...
) -> Result<(), Qwen3_5MoETokenizerError> {
    ...
    if total_context_tokens > maximum_context_tokens {
        return Err(Qwen3_5MoETokenizerError::TotalContextTooLarge {
...
#[derive(Clone, Debug)]
pub struct Qwen3_5MoETokenDecoder {
    tokenizer: Arc<Tokenizer>,
    model_vocabulary_size: u32,
    token_ids: Qwen3_5MoETokenIds,
...
impl Qwen3_5MoETokenDecoder {
    ...
    pub fn push_token(
        ...
        {
            return Err(Qwen3_5MoETokenizerError::GeneratedTokenOutOfVocabulary {
                generated_token_id,
                model_vocabulary_size: self.model_vocabulary_size,
            });
        }
        ...
        let candidate_text = self
            ...
            .map_err(|source| Qwen3_5MoETokenizerError::DecodeGeneratedTokens { source })?;
    ...
    pub fn finish(&mut self) -> Result<Option<String>, Qwen3_5MoETokenizerError> {
    ...
    fn flush_via_full_decode(&mut self) -> Result<Option<String>, Qwen3_5MoETokenizerError> {
        let full_decoded_text = self
            .tokenizer
            .decode(&self.generated_token_ids, true)
            .map_err(|source| Qwen3_5MoETokenizerError::DecodeGeneratedTokens { source })?;
        if !full_decoded_text.starts_with(&self.emitted_text) {
            return Err(Qwen3_5MoETokenizerError::DecodedTextRewrotePrefix);
        }
...
struct PreparedChatImages {
    ...
    processed_visual_images: Vec<Qwen3_5MoEProcessedImage>,
}

fn prepare_chat_images(
    messages: &[ChatMessage],
    image_processor: Option<&Qwen3_5MoEImageProcessor>,
) -> Result<PreparedChatImages, Qwen3_5MoETokenizerError> {
    ...
    for message in messages {
        if let ChatMessage::User { images, .. } = message {
            ...
            for image_input in images {
                let image_processor =
                    image_processor.ok_or(Qwen3_5MoETokenizerError::ImageInputUnsupported)?;
                let processed_image = image_processor
                    .process_image_bytes(&image_input.decoded_bytes)
                    .map_err(Qwen3_5MoETokenizerError::ImageProcessing)?;
...
fn validate_token_identity(
    ...
    {
        return Err(Qwen3_5MoETokenizerError::SpecialTokenMismatch {
            token_content,
            expected_token_id,
            actual_token_id,
        });
