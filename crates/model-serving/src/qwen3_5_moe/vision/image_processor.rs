//! CPU image decoding and Qwen3-VL patch packing for Qwen3.5-MoE.
//!
...
use super::vision_config::Qwen3_5MoEVisionConfig;
...
pub struct Qwen3_5MoEImageGrid {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct Qwen3_5MoEImageDimensions {
...
pub struct Qwen3_5MoEProcessedImage {
    ...
    pub image_grid: Qwen3_5MoEImageGrid,
...
#[derive(Debug, Clone)]
pub struct Qwen3_5MoEImageProcessor {
...
#[derive(Debug, Error)]
pub enum Qwen3_5MoEImageProcessingError {
...
impl Qwen3_5MoEImageProcessor {
    ...
    /// `image_std_by_channel`, `rescale_factor`) are Qwen3.5-MoE-family constants
    /// that are the same across all models in this family.
    pub fn from_vision_config(vision_config: &Qwen3_5MoEVisionConfig) -> Self {
        Self {
    ...
    pub fn process_image_bytes(
    ...
    ) -> Result<Qwen3_5MoEProcessedImage, Qwen3_5MoEImageProcessingError> {
        ...
        let decoded_dynamic_image = ImageReader::new(Cursor::new(encoded_image_bytes))
            .with_guessed_format()
            .map_err(
                |format_guess_error| Qwen3_5MoEImageProcessingError::ImageFormatGuess {
                    source: format_guess_error,
                },
            )?
            .decode()
            .map_err(
                |image_decode_error| Qwen3_5MoEImageProcessingError::ImageDecode {
    ...
    ) -> Result<Qwen3_5MoEImageDimensions, Qwen3_5MoEImageProcessingError> {
        self.validate_config()?;
    ...
    fn process_rgb_image(
        ...
        let total_pixel_value_count = pixel_values_row_count
            ...
            .ok_or_else(|| Qwen3_5MoEImageProcessingError::InvalidProcessorConfig {
    ...
    fn smart_resize_dimensions(
        ...
        if height_pixels == 0 || width_pixels == 0 {
            return Err(Qwen3_5MoEImageProcessingError::InvalidProcessorConfig {
        ...
        if aspect_ratio > QWEN3_5_MOE_MAXIMUM_ASPECT_RATIO {
            return Err(Qwen3_5MoEImageProcessingError::AspectRatioTooLarge {
                height_pixels,
                width_pixels,
                aspect_ratio,
    ...
    fn flatten_pixel_values(
        ...
        image_grid: Qwen3_5MoEImageGrid,
    ...
    fn pixel_values_row_count(
        &self,
        image_grid: Qwen3_5MoEImageGrid,
    ) -> Result<usize, Qwen3_5MoEImageProcessingError> {
        ...
        usize::try_from(row_count).map_err(|_conversion_error| {
            Qwen3_5MoEImageProcessingError::InvalidProcessorConfig {
                message: "image grid row count overflows this platform".to_owned(),
            }
        })
    }

    fn pixel_values_column_count(&self) -> Result<usize, Qwen3_5MoEImageProcessingError> {
    ...
    fn validate_config(&self) -> Result<(), Qwen3_5MoEImageProcessingError> {
