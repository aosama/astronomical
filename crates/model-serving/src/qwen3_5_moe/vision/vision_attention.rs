...
use super::{Qwen3_5MoEExecutionError, Qwen3_5MoEVisionConfig, Qwen3_5MoEVisionWeights};

/// Runs one unmasked, image-segmented vision attention layer.
#[allow(clippy::too_many_arguments)]
pub(super) fn qwen3_5_moe_vision_self_attention(
    runtime: &MlxRuntime,
    vision_config: &Qwen3_5MoEVisionConfig,
    vision_weights: &Qwen3_5MoEVisionWeights,
