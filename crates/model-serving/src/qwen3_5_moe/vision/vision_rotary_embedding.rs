//! Two-dimensional rotary-position graph for Qwen3.5-MoE vision attention.
//!
...
use super::{Qwen3_5MoEExecutionError, Qwen3_5MoEVisionConfig, Qwen3_5MoEVisionInputPlan};
...
pub(super) struct Qwen3_5MoEVisionRotaryEmbedding;

impl Qwen3_5MoEVisionRotaryEmbedding {
    pub(super) fn build(
        runtime: &MlxRuntime,
        vision_input_plan: &Qwen3_5MoEVisionInputPlan,
        vision_config: &Qwen3_5MoEVisionConfig,
    ) -> Result<(MlxArray, MlxArray), Qwen3_5MoEExecutionError> {
