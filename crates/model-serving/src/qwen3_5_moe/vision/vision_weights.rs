...
use super::{
    Qwen3_5MoEExecutionError, ValidatedQwen3_5MoEArtifact, qwen3_5_moe_vision_tensor_profiles,
};

/// Strict tensor binding for the Qwen3.5-MoE vision tower.
///
...
///
/// For embedded vision, `Qwen3_5MoEWeights::model_shards` keeps the source
/// maps alive instead.
/// In this case `vision_sidecar` is `None`.
#[derive(Debug)]
pub struct Qwen3_5MoEVisionWeights {
    ...
    /// models where the model shards in `Qwen3_5MoEWeights` keep
    /// the data alive.
    #[allow(dead_code)]
...
impl Qwen3_5MoEVisionWeights {
    ...
    pub fn load_from_sidecar(
        ...
        let vision_tensor_profiles = qwen3_5_moe_vision_tensor_profiles(vision_config);
    ...
    pub fn load_from_model_shards(
        vision_config: &super::Qwen3_5MoEVisionConfig,
    ...
    pub fn tensor(&self, tensor_name: &str) -> Result<&MlxArray, Qwen3_5MoEExecutionError> {
        self.bound_tensors
            .get(tensor_name)
            .ok_or_else(|| Qwen3_5MoEExecutionError::MissingTensor {
