...
use astronomical_model_serving::{
    QuantizationMode, Qwen3_5MoEArtifactValidator, Qwen3_5MoEModel, RequestDecoderStateStack,
...
async fn run_oq4e_range_coalescing_benchmark() {
    ...
    assert_eq!(
        qwen3_5_moe_model.runtime().memory_limits(),
    ...
    let model_load_memory_snapshot = qwen3_5_moe_model
        .runtime()
        .memory_snapshot()
    ...
    let model_activation_memory_snapshot = qwen3_5_moe_model
        .runtime()
        .memory_snapshot()
