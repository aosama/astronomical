...
use astronomical_model_serving::{
    Qwen3_5MoEArtifactValidator, Qwen3_5MoEModel, Qwen3_5MoEPagedPrefillExecutionMode,
    Qwen3_5MoETokenizer, RequestDecoderStateStack,
};
...
pub(crate) async fn run_prefill_snapshot(
    ...
    let final_position_logits = match paged_prefill_execution_mode {
        Some(paged_prefill_execution_mode) => qwen3_5_moe_model
        ...
        None => qwen3_5_moe_model.forward_chunk(prompt_token_ids, 0, &mut request_decoder_state),
    }
