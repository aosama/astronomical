...
async fn construct_model_artifact_expert_pager(
    ...
    astronomical_model_serving::Qwen3_5MoEConfig,
    astronomical_model_serving::ExpertPager,
) {
    use astronomical_model_serving::{ExpertPager, Qwen3_5MoEArtifactValidator};
...
#[cfg(feature = "direct-mlx")]
fn qwen3_6_27b_oq4e_mtp_model_directory() -> std::path::PathBuf {
