...
use astronomical_model_serving::{
    ...
    Qwen3_5MoEArtifactValidator, Qwen3_5MoEEngine, Qwen3_5MoEInferenceRequest, Qwen3_5MoEModel,
    Qwen3_5MoEPrefillChunckSizer, RequestDecoderStateStack,
};
...
async fn assert_exact_final_prefill_logit_parity() {
    ...
    let qwen3_5_moe_model = Qwen3_5MoEModel::load(
        runtime,
        validated_artifact,
        &configured_model_directory,
        false,
...
fn final_prefill_logits_for_chunk_size(
    ...
    qwen3_5_moe_config: &astronomical_model_serving::Qwen3_5MoEConfig,
    ...
    let greedy_token_id = qwen3_5_moe_model
...
async fn run_native_prefill_capacity_retry_qualification() {
    ...
    let engine_load_result =
        load_engine_with_progress(&mut qwen3_5_moe_engine, "retry-reference").await;
    ...
    let mlx_memory_limit_adjustment = qwen3_5_moe_engine
