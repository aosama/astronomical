...
async fn should_execute_depth_one_mtp_with_complete_resident_experts() {
    timeout(Duration::from_secs(120), async {
        ...
        let mlx_memory_limits = crate::common::
            sample_machine_model_artifact_qualification_mlx_memory_limits()
            .await;
        ...
        assert_eq!(
            ...
            "qualification requires the native depth-one MTP path"
        );
    ...
    .await
    .expect("resident depth-one MTP qualification must finish within 120 seconds");
}
