use astronomical_model_serving::Qwen3_5MoEVisionConfig;
...
fn should_allow_a_text_only_qwen_config_without_vision_config() {
    ...
    let vision_config =
        Qwen3_5MoEVisionConfig::from_optional_json_bytes(text_only_config_json.as_bytes())
...
fn should_accept_the_dense_qwen3_5_vision_model_type() {
    ...
    let vision_config = Qwen3_5MoEVisionConfig::from_json_bytes(config_bytes.as_bytes())
...
fn should_reject_an_ornith_vision_config_with_the_wrong_model_type() {
    ...
    let result = Qwen3_5MoEVisionConfig::from_json_bytes(config_bytes.as_bytes());
    assert!(
        result.is_err(),
