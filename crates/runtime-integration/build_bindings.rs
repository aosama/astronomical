...
const BINDGEN_FUNCTION_ALLOWLIST: &str = concat!(
    ...
    "max_axis|multiply|negative|put_along_axis|quantize|quantized_matmul|repeat_axis|reshape|sigmoid|sin|slice(_update)?|softmax_axis|subtract|sum_axis|tanh|less|",
