...
async fn should_measure_one_layer_generation_expert_data_plane() {
    require_aligned_expert_pack_completion(run_expert_data_plane_measurements(
        ExpertDataPlaneModel {
            model_id: super::large_sparse_moe_model_id(),
        },
...
#[tokio::test]
#[ignore = "measures generation and prefill data planes in balanced order on the large sparse MoE e2e fixture"]
async fn should_measure_the_large_sparse_moe_expert_data_plane_in_both_orders() {
    require_aligned_expert_pack_completion(run_expert_data_plane_measurements(
        ExpertDataPlaneModel {
            model_id: super::large_sparse_moe_model_id(),
        },
...
async fn run_expert_data_plane_measurements(
    ...
    let model_directory = super::configured_model_directory_by_id(expert_data_plane_model.model_id)
