...
main() {
    ...
    grep -Fx -- '--test --test-reporter=spec apps/supervisor/console/console.test.js apps/supervisor/console/library.test.js apps/supervisor/console/library-fetch.test.js apps/supervisor/console/connect.test.js' "$node_log" >/dev/null
